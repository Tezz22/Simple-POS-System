<template>
  ...
  >
    <h3
      class="text-xs font-black uppercase text-textSecondary dark:text-gray-400 border-b pb-2 mb-4 tracking-wider flex items-center gap-2"
    >
      <Icon icon="heroicons:calculator-solid" class="w-4 h-4" />
      Pembayaran Tunai
    </h3>
    ...
    <div class="space-y-4">
      ...
      <button
        ...
        class="w-full py-3 rounded-xl text-xs font-black uppercase tracking-wider text-white bg-primary dark:bg-primaryLight dark:text-gray-900 shadow-sm cursor-pointer transition-all active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed disabled:pointer-events-none flex items-center justify-center gap-2"
      >
