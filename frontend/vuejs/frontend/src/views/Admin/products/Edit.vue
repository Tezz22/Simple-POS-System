  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
    <div class="px-4 sm:px-6 lg:px-8 py-8 max-w-3xl mx-auto space-y-6">
      ...
      >
        <!-- Info Alert -->
        <div
          class="bg-blue-50 dark:bg-blue-950/20 border-b border-blue-200 dark:border-blue-900/30 p-4 flex items-start gap-3"
        >
          <Icon
          ...
          <div>
            ...
            <p class="text-sm text-blue-800 dark:text-blue-300">
              Kode Produk tidak dapat diubah. Pastikan harga jual lebih tinggi dari harga beli
              pokok.
            </p>
          </div>
        </div>
        ...
        <div class="p-6">
          <form @submit.prevent="handleSubmit" class="space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormGroup label="Kode Produk / SKU" required :error="errors?.code">
                  ...
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Kode produk bersifat tetap dan tidak dapat diubah
                  </p>
                </FormGroup>
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  />
                  <p v-if="priceError" class="mt-1 text-xs text-red-600 dark:text-red-400">
                    {{ priceError }}
                  </p>
                </FormGroup>
              </div>
            ...
            <!-- Action Buttons -->
            <div
              class="pt-4 border-t border-gray-200 dark:border-gray-700 flex items-center justify-end gap-3"
            >
              <button
                type="button"
                @click="handleCancel"
              ...
              >
                <Icon
                  v-if="!isSubmitting && !productStore.loading"
                ...
                <span>
                  {{ isSubmitting || productStore.loading ? 'Menyimpan...' : 'Perbarui Produk' }}
                </span>
              </button>
            </div>
          </form>
...
onMounted(async () => {
  try {
    ...
    const product = await productStore.fetchById(route.params.id)
